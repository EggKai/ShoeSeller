...
<h1>Cookie Policy</h1>
    ...
    <ol>
        <p>A cookie is a small data file which, in the form of a unique anonymous code, is sent to your browser from a web server and then stored on the hard disk of your device (computer, smartphone, tablet).
            ...
            Cookies may be installed by the website you are visiting (hereinafter “First Party Cookies”) or they may be installed by other websites (hereinafter “Third-Party Cookies”).</p>
    </ol>
    </div>
...
For further information on cookies and to manage your preferences in relation to Third Party Profiling Cookies we would invite you to visit http://www.youronlinechoices.com. Once you are on the site, if you enter the “Your Choices” area, you can view a list of the third-party companies, our partners, which install cookies on our site (Companies), check the presence and state of activity of the installed cookies (Status) and manage your consent on a selective basis (On/Off). If you expand the “Info” heading for each company, this will take you to more information on the company concerned and provide a link to the information issued by that company on privacy and cookies.
    ...
    <ol>
        ...
        You may enforce your rights, in addition to the use of the means described above, by sending a written communication to the Data Controller at the address indicated above or by sending it an e-mail at privacy@newguardsgroup.com.
        We also remind you that you can always file a claim to the Regulatory Authority (the Italian Data Protection Authority).
        </p>
    </ol>
    </div>
