...
CREATE TABLE `orders` (
  ...
  `email` varchar(255) DEFAULT NULL COMMENT 'If user is a guest he must stay contactable',
...
--
DELIMITER $$
CREATE TRIGGER `set_expires_at` BEFORE INSERT ON `reset_password` FOR EACH ROW BEGIN
